...
A complete tutorial (R markdown) for using our software and reproducing the simulation results provided in the article is contained in `simulationStudy.Rmd` (Section 3). The analysis on sensor data is included in `GesturePhase.Rmd`. 
