...
A complete tutorial (R markdown) for using our software is contained in `simulationStudy1.Rmd` and `simulationStudy2.Rmd`, reproducing the simulation results provided in the article. The analysis on sensor data is contained in `GesturePhase.Rmd`
